...
import psycFinalSubmit from "../../actions/Passcode/psycFinalSubmit";
import InstructionPage from "../../components/Exams/InstructionPage.jsx";

function PsychometricFinalSubmit() {
  ...
  const psycFinalExamSubmitHandler = async () => {
    try {
      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="h-fit p-4 bg-zinc-100 rounded-3xl mx-8 flex flex-col gap-4">
          ...
          <div
            ...
            onClick={psycFinalExamSubmitHandler}
          >
...
export default PsychometricFinalSubmit;
