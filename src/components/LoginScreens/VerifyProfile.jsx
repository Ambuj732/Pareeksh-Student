      ...
      if (userData["usercode"] != undefined && errorForm == "") {
        if (
          ...
          if (userinfo == undefined || userinfo == null) {
            ...
            var studentid = 0;
            console.log(settings.theory2_login);
            console.log(settings.entered_psyc);
            if (settings.theory2_login == 1) {
              latlong =
                geoipresponse["latitude"] + "," + geoipresponse["longitude"];
          ...
          if (response.status == 200) {
            ...
            if (code == 1000) {
              if (verifyStatus == 0) {
                ...
                console.log("Hi");
                console.log(theoryexam);
                console.log("Hi");

                // need to check theoryexam value is 1 or 0
