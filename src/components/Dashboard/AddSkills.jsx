...
const AddSkills = ({ onClose }) => {
  ...
  const { register: registerPublicLink, handleSubmit: handleSubmitPublicLink } =
    useForm();
  const {
  ...
  const addCertificateHandler = async (formData) => {
    try {
      ...
      const data = {
        ...
        doc_type: formData?.certificateFile[0]?.type == "image/png" ? 1 : 2,
    ...
    <div className=" flex h-screen w-screen items-center justify-center  fixed top-0 left-0 z-50 bg-black bg-opacity-50 ">
      <div className="w-1/2 h-2/3 rounded-md shadow-lg ">
        ...
        <div className="overflow-y-scroll h-[90%] bg-white">
              ...
              <div>
                ...
                >
                  ...
                  {sectors?.map((sectorName) => (
                    <option key={sectorName?.id} value={sectorName.id}>
                      {sectorName.job_role}
                    </option>
                  ))}
                </select>
              ...
              <div>
                ...
                >
                  ...
                  {diffLevel?.map((dflevel) => (
                    <option key={dflevel?.id} value={dflevel.id}>
          ...
          <div>
            <h1 className="px-5 mt-16 font-semibold">Update Profile Summary</h1>
          </div>
          <form
            onSubmit={handleSubmitProfileSummary(updateProfileSummaryHandler)}
          ...
          <div>
            <h1 className="px-5 mt-16 font-semibold">Add Accomplishments</h1>
          </div>
          <form
            onSubmit={handleSubmitAccomplishment(addAccomplishmentHandler)}
              ...
              <div className="relative h-12 w-full">
                <div>
                  <input
                    ...
                    className="block pl-8 text-black pb-2.5 pt-5 w-full text-base border border-[#6E6E6E] rounded-md appearance-none  dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 peer"
                    placeholder=""
                    {...registerAccomplishment("accomplishment", {
                      required: true,
                    })}
                  />
                  <div
          ...
          <div>
            <h1 className="px-5 mt-16 font-semibold">Add Public Links</h1>
          </div>
          <form
          ...
          <div>
            <h1 className="px-5 mt-16 font-semibold">Add Key Skills</h1>
          </div>
          <form
          ...
          <div>
            <h1 className="px-5 mt-16 font-semibold">Add IT Skills</h1>
          </div>
          ...
          <div>
            <h1 className="px-5 mt-7 font-semibold">Add Projects</h1>
          </div>
          <hr className="border-black mt-1 mx-4"></hr>
          ...
          <form onSubmit={handleSubmitCertificate(addCertificateHandler)}>
            {
              ...
              <div className="relative h-12 w-1/2">
                <div>
                  <input
                    ...
                    className="block pl-8 text-black pb-2.5 pt-5 w-full text-base border border-[#6E6E6E] rounded-md appearance-none  dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 peer"
                    placeholder=""
                    {...registerCertificate("certificateProvider", {
                      required: true,
                    })}
                  />
                  <div
              ...
              <div className="relative h-12 w-1/2">
                <div>
                  <input
                    ...
                    className="block pl-8 text-black pb-2.5 pt-5 w-full text-base border border-[#6E6E6E] rounded-md appearance-none  dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 peer"
                    placeholder=""
                    {...registerCertificate("completionYear", {
                      required: true,
                    })}
                  />
                  <div
