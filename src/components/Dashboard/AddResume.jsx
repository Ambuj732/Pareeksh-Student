  ...
  const updateVideoResumeHandler = async () => {
    try {
      const data = {
        id_self_student: user?.id_self_student,
        usercode: user?.usercode,
        file_name: `VideoResume-${Math.floor(Math.random() * 10000)}.mp4`,
        doc_type: 3,
        file: videoResume,
      };
      console.log(data);
    ...
    <div className="flex h-screen w-screen items-center justify-center fixed top-0 left-0 z-50 bg-black bg-opacity-50 ">
      <div className="w-1/2 h-2/3 rounded-md shadow-md">
        ...
        <div className="overflow-y-scroll h-[90%] bg-white">
          <div>
            <h1 className="px-5 mt-4 font-semibold">Add Resume Headline</h1>
          </div>
          <hr className="border-black mt-1 mx-4"></hr>
          <form
            onSubmit={handleSubmitResumeHeadline(updateResumeHeadlineHandler)}
          ...
          >
            <div className="border mx-5 mt-3 h-12 flex items-center justify-center">
              ...
              />
              <label htmlFor="resumeFile" className="text-[#1C4481]">
          ...
          <div>
            <h1 className="px-5 mt-4 font-semibold">Add Video Resume</h1>
          </div>
          <hr className="border-black mt-1 mx-4"></hr>
