  ...
  return (
    <div className="flex flex-col gap-4">
      <span className="text-sm">
        To Use the speech to text feature, Please select your preferred language
        and clicking on the start button. You can click on the stop button to
        Stop Speech
      </span>
      <div className="flex">
        ...
        <div className="bg-white h-24 w-full ml-4 text-sm p-2 rounded-md">
          ...
          <div className="flex justify-between">
            <div className="h-16 py-1 flex flex-col justify-between">
              <span className="text-[#0C49CA]">Primary Language</span>
            ...
            <div className="h-16 py-1 flex flex-col justify-between ">
              <span className="text-[#0C49CA]">Secondary Language</span>
              <div className="flex items-center justify-between w-28 border px-2 border-black rounded-md py-1">
